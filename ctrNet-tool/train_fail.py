...
features = ['uid', 'aid', 'time', 'siteid', 'slotid', 'cid', 'net',
                    'age', 'gender', 'city', 'province', 'phoneType', 'carrier',
                    'billid', 'primid', 'creative', 'inter', 'app', 'c1', 'c2']


dev = 'data/merge_train_clean_random1000000_trim_uid.csv'
# train = 'data/merge_train_clean.csv'
train = 'data/unique_uid_merge_test_in_train_clean.csv'
# train = 'data/merge_train_rm_robot_time_26_31_clean_trim_uid.csv'
test = 'data/merge_test_clean_trim_uid.csv'

save_steps = 38800  # 38000
lr = 0.0002  # 0.0002
k = 16
#hashids = int(2e5)  # 2e5
...
train_df.columns = ['label'] + features
...
dev_df.columns = train_df.columns
...
hparam.dict = {'uid': 20000000, 'aid': 5000, 'time': 24, 'siteid': 100, 'slotid': 100, 'cid': 10000, 'net': 10,
                'age': 8, 'gender': 4, 'city': 300, 'province': 50, 'phoneType': 500, 'carrier': 7,
                'billid': 8, 'primid': 10, 'creative': 300, 'inter': 5, 'app': 50, 'c1': 300, 'c2': 300}
